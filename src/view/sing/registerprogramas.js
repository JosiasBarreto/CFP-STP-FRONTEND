        ...
        <Modal.Body>
          <Form noValidate onSubmit={formik.handleSubmit}>
            <Form.Group className="mb-" style={{ display: "none" }}>
              ...
              <Form.Control type="text" name="id" readOnly={true} value={id} />
            </Form.Group>
            ...
            >
              <Form.Control
                ...
                onChange={formik.handleChange}
                isInvalid={
                  formik.touched.publico_alvo && formik.errors.publico_alvo
                }
              />
              <Form.Control.Feedback type="invalid">
            ...
            >
              <Form.Select
                ...
                isInvalid={formik.touched.duracao && formik.errors.duracao}
